...
<div class="text-sm text-surface-400 space-y-1 mb-4">
	...
	{#if mystery.monsterWeakness}<p><strong>Weakness:</strong> {mystery.monsterWeakness}</p>{/if}
	{#if mystery.howItWasKilled}<p><strong>Resolution:</strong> {mystery.howItWasKilled}</p>{/if}
</div>
